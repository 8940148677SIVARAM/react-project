                    ...
                    <div className='form'>
                        ...
                        <div className='row just'>
                            <div className={n ? "border col-6" : " col-6"}>
                                <div className='name'>
                                    <TextField label="First name" variant="outlined" name='fname' value={name} onChange={signup} />
                                </div>
                            </div>
                            <div className={s ? "border col-6" : "col-6"}>
                                <div className='name'>
                                    <TextField label="Surname" variant="outlined" name='sname' value={sname} onChange={signup} />
                                </div>
                            </div>
                        </div>
                        <div className='row'>
                            <div className={e ? "border col-12" : " col-12"}>
                                <TextField label="email address" type="email" variant="outlined" name='email' value={email} onChange={signup} />
                            </div>
                        </div>
                        <div className='row'>
                            <div className={p ? "border col-12" : "col-12"}>
                                <TextField type="password" label="Password" variant="outlined" name='pass' value={pass} onChange={signup} />
                            </div>
                        </div>
                        <p>Date of birth</p>
                        <div className='row just'>
                            <div className='col-4'>
                                <select name="bday" onChange={signup} required>
                                    {
                                        date.map((e: number, i: any) => <option value={e} key={e}>{e}</option>)
                                    }
                                </select>
                            </div>
                            <div className='col-4'>
                                <select name="bmonth" onChange={signup} required>
                                    {
                                        month.map((e: string, i: any) => <option value={e} key={e}>{e}</option>)
                                    }
                                </select>
                            </div>
                            <div className='col-4'>
                                <select name="byear" onChange={signup} required>
                                    {
                                        year.map((e: string, i: any) => <option value={e} key={e}>{e}</option>)
                                    }
                                </select>
                            </div>
                        </div>
                        ...
                        <div className='row just'>
                            <div className='col-4'>
                                <div className="boy">
                                    <label htmlFor="a">Boy</label><input type="radio" value="Male" name="gender" id="a" onChange={signup} required ></input>
                                </div>
                            </div>
                            <div className='col-4'>
                                <div className="boy">
                                    <label htmlFor="b">Girl</label><input type="radio" value="Female" name="gender" id="b" onChange={signup} required></input>
                                </div>
                            </div>
                            <div className='col-4'>
                                <div className="boy">
                                    <label htmlFor="c">Custom</label><input type="radio" value="Custom" name="gender" id="c" onChange={signup} required></input>
                                </div>
                            </div>
                        </div>
